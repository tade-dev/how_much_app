                ...
                child: Column(
                  children: [
                    ...
                    Buttons.primaryButton(
                      isLoading: state.changePasswordStatus.isInProgress,
                      isDisabled: !state.isChangePasswordButtonEnabled,
                        label: "Change", hasIcon: false, onTap: () {
                        _formKey.currentState!.validate() ?
                        context.read<ForgotPasswordCubit>().initiateUpdatePassword(context):
